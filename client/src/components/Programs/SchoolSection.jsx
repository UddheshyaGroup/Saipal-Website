          ...
          <div className="relative z-10 flex items-start gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="space-y-6 text-blue-50/90 leading-relaxed text-lg">
                <p>
                  Every child is encouraged to grow in a healthy manner. Each
                  student is encouraged to sharpen their inner talents and not
                  just focus on grades.
                </p>
                <p>
                  We provide a platform to explore oneself and identify core
                  competence. This is facilitated by optimal class sizes and
                  close, intimate teacher-student relationships.
                </p>
              </div>
            </div>
          </div>
