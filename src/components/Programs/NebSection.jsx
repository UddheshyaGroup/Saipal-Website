          ...
          <div className="relative z-10 flex items-start gap-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="space-y-6 text-blue-50/90 leading-relaxed text-base">
                <p>
                  One of the distinguishing features of our +2 program is the
                  emphasis on holistic professional growth. We encourage every
                  student to develop their unique potential rather than solely
                  focusing on grades.
                </p>
                <p>
                  Saipal Academy emphasizes a student-centered, interactive
                  approach to learning. To deepen understanding, students engage
                  in practical activities, research, and project work.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 flex items-start gap-6">
            <div className="flex-1 min-w-0">
              ...
              <div className="text-slate-600 font-medium leading-relaxed">
                <p>
                  Admission arrangements are discussed in detail with parents
                  and it is carried out on the basis of entrance test followed
                  by an interview. Students must pass SAHSS entrance test to be
                  qualified for the admission. The final selection is decided by
                  the selection committee of the college.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 flex items-start gap-6">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-slate-600 leading-relaxed font-medium">
                After successful completion of the +2 program, our students are
                ready to study in any university in Nepal or abroad. We also
        ...
        <div className="group relative overflow-hidden rounded-[2.5rem] border border-slate-100 bg-white p-8 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.03)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_40px_80px_-15px_rgba(59,130,246,0.1)]">
          <div className="relative z-10 flex items-start gap-6">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-slate-600 leading-relaxed font-medium">
                We provide expertise to pave the way for student's career in
                multidisciplinary areas through guidance and counseling.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="group relative overflow-hidden rounded-[2.5rem] border border-slate-100 bg-white p-8 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.03)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_40px_80px_-15px_rgba(59,130,246,0.1)]">
          <div className="relative z-10 flex items-start gap-6">
            <div className="flex-1 min-w-0">
              ...
              <p className="text-slate-600 leading-relaxed font-medium">
                We have eminent personalities who provide expert suggestions on
                academic matters and share their experiences with students.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-slate-600 font-medium text-sm">
                    25%–75% tuition fee support for students from minority
                    sectors or deprived backgrounds.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="overflow-hidden rounded-2xl border border-slate-100 bg-slate-50/50 mt-8">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-white">
                      <th className="px-4 py-4 text-left font-bold text-slate-900">
                        Score
                      </th>
                      <th className="px-4 py-4 text-center font-bold text-slate-900">
                        GP
                      </th>
                      <th className="px-4 py-4 text-center font-bold text-slate-900">
                        Grade
