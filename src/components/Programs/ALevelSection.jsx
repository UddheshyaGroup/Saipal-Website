...
import { GraduationCap, Award, Target, Users, BookOpen, Calendar } from "lucide-react";
...
export default function ALevelSection() {
    ...
    const getCurrentCourses = () => {
        switch (activeTable) {
            case "medical": return medicalCourses;
            case "engineering": return engineeringCourses;
            case "management": return managementCourses;
            case "humanities": return humanitiesCourses;
            default: return medicalCourses;
        }
    };
    ...
    return (
        <>
            ...
            <div className="mt-16 grid gap-8 lg:grid-cols-2">
                {/* WHY A LEVEL */}
                <div className="group relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 py-8 pl-8 pr-4 text-white shadow-2xl transition-all duration-500 hover:-translate-y-2">
                ...
                <div className="group relative overflow-hidden rounded-[2.5rem] border border-slate-100 bg-white py-8 pl-8 pr-4 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_40px_80px_-15px_rgba(59,130,246,0.1)]">
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="bg-white">
                                    <th className="px-5 py-4 text-left font-bold text-slate-900">Subject</th>
                                    <th className="px-5 py-4 text-center font-bold text-slate-900">Type</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-slate-100">
                                {getCurrentCourses().map((course, index) => (
                                    <tr key={index} className="transition-colors hover:bg-white group/row">
                                        <td className="px-5 py-4 font-medium text-slate-700 text-sm sm:text-base">
                                            {course.subject}
                                        </td>
                                        <td className="px-5 py-4 text-center text-xs">
                                            <span className={`inline-flex rounded-full px-3 py-1 font-bold ${course.type === "Core"
                    ...
                    <div className="mt-6 flex items-center gap-3 rounded-2xl bg-blue-50/50 p-4 text-sm font-medium text-blue-700 border border-blue-100/50">
                        ...
                        <p><span className="font-bold">Note:</span> Choose 4 core subjects plus electives.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                    ...
                    const isSpecialBg = section.title === "Why choose Cambridge A Levels at Saipal Academy?";
                    ...
                    return (
                        <div
                            ...
                            className={`group relative overflow-hidden rounded-[2.5rem] py-8 pl-8 pr-4 transition-all duration-500 hover:-translate-y-2 ${isFullWidth ? "md:col-span-2" : ""
                                    ...
                                    ? "bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white shadow-xl"
                        ...
                        >
                            ...
                            <div className="relative z-10 flex items-start gap-6">
                                <div className={`rounded-2xl p-4 shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6 ${isSpecialBg
                                ...
                                <div className="flex-1 min-w-0">
                                    <h2 className={`text-2xl font-bold mb-4 ${isSpecialBg ? "text-white" : "text-slate-900"}`}>
                                        {section.title}
                                    </h2>
                ...
                <div className="relative z-10 flex items-start gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-slate-600 font-medium text-sm sm:text-base">
                            SAHSS provides scholarships for deserving and meritorious SEE graduates.
                            Scholarship evaluation is based on <b className="font-semibold text-slate-800">50% SAHSS Entrance Score</b> and
                            <b className="font-semibold text-slate-800"> 50% SEE Score</b>.
                            Only 50% of the enrollment fee is charged. Admission form fee: <b className="font-semibold">Rs. 500</b>.
                        </p>
                            ...
                            <div className="space-y-4">
                                ...
                                <ul className="space-y-3 text-slate-600 font-medium text-sm sm:text-base leading-relaxed">
                                    <li>
                                        ...
                                        <span className="text-slate-800 font-semibold"> (25% – 75% tuition support)</span>
                                    </li>
                                    <li>
