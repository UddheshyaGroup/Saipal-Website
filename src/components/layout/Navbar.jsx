...
export default function Navbar() {
  ...
  return (
    <>
      {/* 🔹 TOP INFO BAR */}
      <div
        className={`bg-accent text-white text-[11px] sm:text-sm transition-all duration-300 ${
          showTopBar
                  ...
                  <div className="mt-12 pt-8 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-3">
                      {[
                        {
                          icon: Facebook,
                          url: "https://facebook.com/saipalacademy",
                        },
                        {
                          icon: Instagram,
                          url: "https://instagram.com/saipalacademy",
                        },
                        {
                          icon: Twitter,
                          url: "https://twitter.com/saipalacademy",
                        },
                        {
                          icon: Linkedin,
